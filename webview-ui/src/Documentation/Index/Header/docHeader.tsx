        ...
        return (
            <div className="vscode-header doc-index-header">
                <div id="doc-index-searchbar-wrapper">
                    <VSCodeTextField autofocus id='searchbar' placeholder='Search documentation...' onInput={(e) => { if (this.props.handleSearchInput) this.props.handleSearchInput((e.target as HTMLInputElement).value) }} ref={this.textField} value={this.props.filter} />
                </div>
            </div>
        );
    }
